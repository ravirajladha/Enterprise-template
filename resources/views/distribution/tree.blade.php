        ...
        <div class="container-fluid">
            ...
            <div class="product-tree">
                <ul class="tree">
                    <li>
                        <div class="parent">
                            <span class="toggle px-4 pt-3">+</span> New Parent
                            <ul class="nested">
                                <li>
                                    <span class="toggle px-4 pt-3">+</span> Manufacturing
                                    <ul class="nested">
                                        <li>
                                            <span class="toggle px-4 pt-3">+</span> Arena Two
                                            <ul class="nested px-5">
                                                <li class="px-5">Product A<span class="quantity">₹ 0.00</span></li>
                                                <li class="px-5 text-muted">Product B<span class="quantity">₹ 0.00</span></li>
                                                <li class="px-5">Product C<span class="quantity">₹ 0.00</span></li>
                                                <li class="px-5 text-muted">Product D<span class="quantity">₹ 0.00</span></li>
                                    ...
                                    <ul class="nested">
                                        <li>
                                            ...
                                            <ul class="nested px-5">
                                                <li class="px-5">Product A<span class="quantity">₹ 0.00</span></li>
                                                <li class="px-5 text-muted">Product B<span class="quantity">₹ 0.00</span></li>
                                                <li class="px-5 text-muted">Product C<span class="quantity">₹ 0.00</span></li>
