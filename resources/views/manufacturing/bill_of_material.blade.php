                        ...
                        <div class="col-9">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">Bill of Material -> Id:
                                        2024/02/5215858</li>
                                </ol>
                            </nav>
                        </div>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    <label for="exampleInputtext" class="form-label fw-semibold">Product
                                                        Name</label>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                                        value="10" placeholder="Enter Quantity" value>
                                                </div>

                                                <div class="mb-4">
                                                    <label for="exampleInputtext1"
                                                        class="form-label fw-semibold">Operation Date</label>
                                                    <input type="date" class="form-control" id="exampleInputtext1">
                                                </div>
                                                <div class="mb-4">
                                                    <label for="exampleInputtext1"
                                                        class="form-label fw-semibold">Description</label>
                                                    <textarea type="text" class="form-control" id="exampleInputtext1"></textarea>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    <label for="exampleInputtext2"
                                                        class="form-label fw-semibold">Product ID</label>
                                                ...
                                                <div class="mb-4">
                                                    <label for="exampleInputtext2"
                                                        class="form-label fw-semibold">Product Name</label>
                                                    <input type="text" class="form-control" id="exampleInputtext2"
                                    ...
                                    <option value="3">Russia (Ruble)</option>
                                                    ...
                                                    <div class="form-group">
                                                        <input type="date" class="form-control"
                                                            id="exampleInputtextN" placeholder="" value="dd-mm-yyyy">
                                                    </div>
                                    ...
                                    placeholder="+91 12345 65478">
                                                ...
                                                <div class="">
                                                    <label for="exampleInputtext4"
                                                        class="form-label fw-semibold">Product Sample</label>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox3" value="option3" checked /></td>
                                                    <td>Rs 295</td>
                                                    <td>
                          ...
                          <p class="card-subtitle mb-3">
                           This  Data Table provides with ascending/ Descending Functionality
                                ...
                                <button class="btn bg-danger-subtle text-danger">Cancel</button>
                                        ...
                                        <div class="position-relative">
                                            <button type="button" data-bs-toggle="modal"
                                                data-bs-target="#samedata-modal2" data-bs-whatever="@mdo"
                                                class=" btn  btn-rounded btn-primary  align-items-center">
                                                <i class="ti ti-plus fs-4 me-2"></i>
                                                Add Material
                                            </button>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-4">
                                                <label for="exampleInputtext" class="form-label fw-semibold">Operating
                                                    Cost (INR)</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-4">
                                                <label for="exampleInputtext" class="form-label fw-semibold">Total
                                                    Cost (INR)</label>
                                                <input type="number" class="form-control" id="exampleInputtext"
                                                    value="1000" disabled placeholder="Enter Quantity" value>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-4">
                                                <label for="exampleInputtext1" class="form-label fw-semibold">Raw
                                                    Material Cost (INR)</label>
            ...
            <div class="modal-content">
                <div class="modal-header d-flex align-items-center">
                  ...
                  <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label for="operation-name" class="control-label">Operation Name</label>
                            <input type="text" class="form-control" id="operation-name" placeholder="Enter Operation Name" value="Cutting"/>
                        </div>
                        <div class="mb-3">
                            <label for="workstation" class="control-label">Workstation</label>
                            <input type="text" class="form-control" id="workstation" value="Fabric Cutting Station"/>
                        </div>
                        <div class="mb-3">
                            <label for="operation-time" class="control-label">Operation Time</label>
                            <input type="text" class="form-control" id="operation-time" value="10 min"/>
                        </div>
                        <div class="mb-3">
                            <label for="fixed-timing" class="control-label">Fixed Timing</label> &nbsp;
                            <input class="form-check-input" type="checkbox" id="fixed-timing" value="option3" checked/>
                        </div>
                        <div class="mb-3">
                            <label for="operation-cost" class="control-label">Operation Cost (INR)</label>
                            <input type="number" class="form-control" id="operation-cost" value="150"/>
                        </div>
                    </form>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <form>
                    <div class="mb-3">
                        <label for="item-code" class="control-label">Item Code</label>
                        <input type="text" class="form-control" id="item-code" placeholder="Enter Item Code" value="1234ABC"/>
                    </div>
                    <div class="mb-3">
                        <label for="quantity" class="control-label">Quantity</label>
                        <input type="text" class="form-control" id="quantity" placeholder="Enter Quantity" value="100"/>
                    </div>
                    <div class="mb-3">
                        <label for="unit-of-measure" class="control-label">Unit of Measure</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="rate" placeholder="Enter Rate" value="50"/>
                    </div>
                </form>
