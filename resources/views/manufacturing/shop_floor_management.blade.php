...
<div class="row align-items-center">
  <div class="col-9">
    <h4 class="fw-semibold mb-8">Shop Floor</h4>
  ...
  <div class="col-3">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="task-title mb-4 d-flex">
                                  <input id="kanban-title" type="text" placeholder="Task" class="form-control"
                                    name="task">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-12">
                                <div class="task-badge d-flex">
                                  <textarea id="kanban-text" placeholder="Task Text" class="form-control"
            ...
            <div class="modal-footer justify-content-start">
              ...
              <button data-btn-action="editTask" class="btn edit-tsk btn-success"
                style="display: none;">Save</button>
              <button class="btn btn-dark d-flex align-items-center gap-1" data-bs-dismiss="modal">Cancel</button>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="list-title d-flex align-items-center">
                          <input id="item-name" type="text" placeholder="List Name" class="form-control"
                            name="task">
                        </div>
                      </div>
                    </div>
                  ...
                  <div data-draggable="true" class="card img-task">
                    <div class="card-body">
                      <div class="task-header">
                        <div class="">
                          <h4 class="" data-item-title="Packing">
                            Packing</h4>
                        </div>
                        <div class="dropdown">
                          <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink-1"
                      ...
                      <div class="task-content">
                        <p class="mb-0"
                          data-item-text="PKG-100-252-141 &#10; Packing Station">
                          PKG-100-252-141&#10; Packing Station
                        </p>
                      </div>
                      <div class="task-body">
    ...
    <script src="../assets/js/apps/kanban.js"></script>  <script src="../assets/libs/jquery-ui/dist/jquery-ui.min.js"></script>
