...
<div class="brand-logo d-flex align-items-center justify-content-between">
  <a href="../main/index.html" class="text-nowrap logo-img">
    <img
      src="../assets/images/logos/dark-logo.svg" style="width:174px;height:26px;"
      class="dark-logo"
      alt="Logo-Dark"
    />
    <img
      src="../assets/images/logos/light-logo.svg" style="width:174px;height:26px;"
      class="light-logo"
      alt="Logo-light"
    />
  </a>
  ...
  <ul id="sidebarnav">
    ...
    <li class="sidebar-item">
      ...
      <ul aria-expanded="false" class="collapse first-level">
        ...
        <li class="sidebar-item">
          <a href="/issue" class="sidebar-link">
            <div
              class="round-16 d-flex align-items-center justify-content-center"
            >
              <i class="ti ti-circle"></i>
        ...
        <li class="sidebar-item">
          <a href="/warranty_claim" class="sidebar-link">
            <div
              class="round-16 d-flex align-items-center justify-content-center"
            >
              <i class="ti ti-circle"></i>
            </div>
            <span class="hide-menu">Warranty Claim</span>
          </a>
        </li>
        <li class="sidebar-item">
        ...
        <li class="sidebar-item">
          <a href="/maintenance_visit" class="sidebar-link">
            <div
              class="round-16 d-flex align-items-center justify-content-center"
            >
              <i class="ti ti-circle"></i>
    ...
    <li class="sidebar-item">
      ...
      <ul aria-expanded="false" class="collapse first-level">
        ...
        <li class="sidebar-item">
          <a href="/warehousetree" class="sidebar-link">
            <div
              class="round-16 d-flex align-items-center justify-content-center"
            >
              <i class="ti ti-circle"></i>
            </div>
            <span class="hide-menu">Warehouse Tree</span>
          </a>
        </li>
